...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260629031159_AddDiscountCodesSystem")]
    partial class AddDiscountCodesSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entities.DriverEarning", b =>
                {
                    ...
                    b.Property<Guid?>("DriverProfileId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.DriverPaymentInfo", b =>
                {
                    ...
                    b.HasIndex("DriverProfileId1")
                        .IsUnique()
                        .HasFilter("[DriverProfileId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Backend.Domain.Entities.DriverEarning", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.Booking", null)
                        .WithOne("DriverEarning")
                        .HasForeignKey("Backend.Domain.Entities.DriverEarning", "BookingId1");
                    ...
                    b.HasOne("Backend.Domain.Entities.DriverProfile", null)
                        .WithMany("Earnings")
            ...
            modelBuilder.Entity("Backend.Domain.Entities.DriverPaymentInfo", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.DriverProfile", null)
                        .WithOne("PaymentInfo")
                        .HasForeignKey("Backend.Domain.Entities.DriverPaymentInfo", "DriverProfileId1");
