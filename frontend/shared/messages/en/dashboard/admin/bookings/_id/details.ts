...
const details: BookingDetailsLabels = {
  ...
  approvalInfo: {
    ...
    subtitle: "Admin approval status and details",
    pendingBanner: "This booking is pending admin approval. Review and approve or reject it.",
    rejectedBanner: "This booking has been rejected.",
    approvedBy: "Approved By",
    approvedByAdmin: "Admin",
    approvedAt: "Approved At",
    rejectionReason: "Rejection Reason",
    rejectButton: "Reject Booking",
    approveButton: "Approve Booking",
  },
  refundDialog: {
